...
//
// Structure mirrors the in-app analytics "Detailed Summary" (see
// packages/lms-web/src/components/analytics/AnalyticsClient.tsx): one table,
// drilled Branch ▸ Source ▸ Assignee, instead of the three disjoint "By source"
// / "By branch" / "By assignee" grids this page used to carry. Two things this
// page has that the dashboard doesn't, both preserved:
//
